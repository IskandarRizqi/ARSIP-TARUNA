					...
					<ul class="nav-menu">
						...
						<li class="submenu">
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><span>Settings</span>
										<span class="menu-arrow"></span>
									</a>
									<ul>
										<li class="submenu">
										...
										<li class="submenu">
											<a href="javascript:void(0);" class="active subdrop">Website Settings<span class="menu-arrow"></span></a>
											<ul>
												...
												<li><a href="language.html" class="active">Language</a></li>
				...
				<div class="twocol-mini">
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist" aria-orientation="vertical">
							...
							<a href="#" class="nav-link active" title="Administration" data-bs-toggle="tab" data-bs-target="#administration">
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-administration" role="tab" class="nav-link active" title="Administration" data-bs-toggle="tab" data-bs-target="#menu-administration" aria-selected="false">
		...
		<div class="page-wrapper">
			<div class="content">
				...
				<ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom mb-3">
					...
					<li class="nav-item">
						<a class="nav-link active" href="bussiness-settings.html"><i class="ti ti-world-cog me-2"></i>Website Settings</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="salary-settings.html"><i class="ti ti-device-ipad-horizontal-cog me-2"></i>App Settings</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="email-settings.html"><i class="ti ti-server-cog me-2"></i>System Settings</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="payment-gateways.html"><i class="ti ti-settings-dollar me-2"></i>Financial Settings</a>
					</li>
					<li class="nav-item">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="business-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Business Settings</a>
									<a href="seo-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">SEO Settings</a>
									<a href="localization-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Localization</a>
									<a href="prefixes.html" class="d-inline-flex align-items-center rounded py-2 px-3">Prefixes</a>
									<a href="preferences.html" class="d-inline-flex align-items-center rounded py-2 px-3">Preferences</a>
									<a href="appearance.html" class="d-inline-flex align-items-center rounded py-2 px-3">Appearance</a>
									<a href="language.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Language</a>
									<a href="authentication-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Authentication Settings</a>
									<a href="ai-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">AI Settings</a>
								</div>
							</div>
						</div>
					</div>
                                        ...
                                        <div class="row align-items-center g-3">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center justify-content-sm-end flex-wrap row-gap-2">
                                                    <a href="language.html" class="btn btn-sm btn-primary d-inline-flex align-items-center me-3">
