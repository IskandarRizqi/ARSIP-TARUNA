                                            ...
                                            <tr>
                                                ...
                                                <td id="countdown-{{ $value->id }}">
                                                    @if($value->jenis_arsip == 'fisik')
                                                        @if($value->status_approval_2 == 'approved')
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    ...
                                                    @endif
                                                    @if(
                                                        in_array($value->status, ['approved', 'rejected']) &&
                                                        $value->jenis_arsip == 'fisik' &&
                                                        $value->status_approval_2 != 'rejected'
                                                    )
                                                        <!-- Teks Kembalikan -->
