                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div style="text-align: right;">
                                <li>
                                    <a href="/mastertujuan/create" class="btn btn-primary">
                                        Tambah
                                    </a>
                                </li>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center" style="gap: 5px; display: inline-flex;">
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('mastertujuan.show', $value->id) }}" class="btn btn-primary btn-sm" 
                                                    ...
                                                    <!-- Tombol Hapus -->
                                                    <form action="{{ route('mastertujuan.destroy', $value->id) }}" method="post" style="margin: 0; padding: 0; display: inline;">
                                                        @csrf
                                                        @method('DELETE')
