        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('masterlemari.update', $edit->id) }}" method="POST">
                            @csrf
                            @method('PUT') <!-- Gunakan PUT untuk update data -->

                            <!-- Nama Kategori -->
                            <label for="nama">Nama  Lemari</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="nama" id="nama" class="form-control" 
                                           placeholder="Masukkan Nama lemari" value="{{ $edit->nama }}" required>
                                </div>
                            </div>
                            ...
                            <a href="{{ route('masterlemari.index') }}" class="btn btn-danger m-t-15 waves-effect">BATAL</a>
                        </form>
                    </div>
                </div>
            </div>
